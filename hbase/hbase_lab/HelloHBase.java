...
public class HelloHBase {
    ...
    private static String family1 = "PersonalData";
    private static String family2 = "ProfessionalData";
    ...
    public static void createHbaseTable() throws IOException {
        ...
        try {
            ...
            p.addColumn(family1.getBytes(), "city".getBytes(), Bytes.toBytes("casablanca"));
            p.addColumn(family2.getBytes(), "company".getBytes(), Bytes.toBytes("sari"));
            p.addColumn(family2.getBytes(), "salary".getBytes(), Bytes.toBytes("4200"));
            table1.put(p);
            ...
            p2.addColumn(family1.getBytes(), "name".getBytes(), Bytes.toBytes("jane"));
            p2.addColumn(family1.getBytes(), "hel".getBytes(), Bytes.toBytes("2121212"));
            p2.addColumn(family2.getBytes(), "profession".getBytes(), Bytes.toBytes("developer"));
            p2.addColumn(family2.getBytes(), "company".getBytes(), Bytes.toBytes("sari2"));
            table1.put(p2);
